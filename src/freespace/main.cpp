...
#endif
            // ProgramArguments::Option_t("video", (DataPath::get() + std::string{"/samples/freespace/video_freespace.h264"}).c_str()),
            ProgramArguments::Option_t("video", (DataPath::get() + "/samples/pilotnet/PilotNet_Video_1.h264").c_str()),
            // ProgramArguments::Option_t("rig", (DataPath::get() + std::string{"/samples/freespace/rig_freespace.xml"}).c_str()),
